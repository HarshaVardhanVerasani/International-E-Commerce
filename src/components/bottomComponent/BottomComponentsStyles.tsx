...
export const BottomComponentStyles=(colors:ColorScheme)=>({
    ...
    contentContainer:{display:'flex',flexDirection:'column',gap:2 ,justifyContent: "center",  alignItems:'center',},
    heading:{ fontSize: {xs:'30px',sm:"40px"},color:colors.mediumBlack },
